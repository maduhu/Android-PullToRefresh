...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected final void setHeaderScroll(int value) {
        ...
        ImageView iView = (ImageView) findViewById(R.id.pull_to_refresh_image);

        if(value == -110){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00160);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -112){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00161);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -114){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00162);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -116){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00163);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -118){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00164);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -120){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00165);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -122){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00166);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -124){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00167);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -126){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00168);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -128){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00169);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -130){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00170);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -132){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00171);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -134){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00172);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -136){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00173);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -138){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00174);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -140){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00175);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -142){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00176);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -144){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00177);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -146){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00178);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -148){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00179);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -150){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00180);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -152){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00181);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -154){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00182);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -156){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00183);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -158){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00184);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -160){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00185);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -162){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00186);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -164){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00187);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -166){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00188);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -168){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00189);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -170){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00190);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -172){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00191);
            iView.setImageDrawable(imageDrawable);
        } else if(value == -174){
            Drawable imageDrawable = getResources().getDrawable(R.drawable.cup_fill_00192);
            iView.setImageDrawable(imageDrawable);
        }
